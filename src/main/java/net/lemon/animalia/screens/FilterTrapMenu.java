...
public class FilterTrapMenu extends AbstractContainerMenu {
    ...
    public FilterTrapMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public FilterTrapMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FILTER_TRAP_MENU.get(), containerId);
        checkContainerSize(inv, 2);
        blockEntity = ((FilterTrapBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.FILTER_TRAP.get());
    }
