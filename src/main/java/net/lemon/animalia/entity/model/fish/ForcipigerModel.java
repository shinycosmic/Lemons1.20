...
public class ForcipigerModel extends GeoModel<RegSchoolingEntity> {
    public ResourceLocation getModelResource(RegSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/forcipiger.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(RegSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/forcipiger.animation.json");
    }
