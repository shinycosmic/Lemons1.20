...
public class ZebrasomaFlavescensModel extends GeoModel<GrazeSchoolingEntity> {
    public ResourceLocation getModelResource(GrazeSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/zebrasomaflavescens.geo.json");
    }

    public ResourceLocation getTextureResource(GrazeSchoolingEntity object) {
        if(object.isBaby()) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/babyzebrasoma.png");
        }
        if(NightBlend.isFullNight(object)) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/zebrasoma_flavescens_night.png");
        }
        return new ResourceLocation(Animalia.MODID, "textures/entity/zebrasoma_flavescens.png");
    }
    ...
    public ResourceLocation getAnimationResource(GrazeSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/zebrasomaflavescens.animation.json");
    }
