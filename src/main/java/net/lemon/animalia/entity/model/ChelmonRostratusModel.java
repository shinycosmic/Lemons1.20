...
public class ChelmonRostratusModel extends GeoModel<RegSchoolingEntity> {
    public ResourceLocation getModelResource(RegSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/chelmonrostratus.geo.json");
    }

    public ResourceLocation getTextureResource(RegSchoolingEntity object) {
        if(object.isBaby()) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/babychelmon.png");
        }
        return new ResourceLocation(Animalia.MODID, "textures/entity/chelmon_rostratus.png");
    }
    ...
    public ResourceLocation getAnimationResource(RegSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/chelmonrostratus.animation.json");
    }
