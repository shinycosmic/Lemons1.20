...
public class SinobdellaSinensisModel extends GeoModel<MastacembelusEntity> {
    public ResourceLocation getModelResource(MastacembelusEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/sinobdellasinensis.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(MastacembelusEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/sinobdellasinensis.animation.json");
    }
