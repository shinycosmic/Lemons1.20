...
public class PomacanthusImperatorModel extends GeoModel<RegSchoolingEntity> {
    public ResourceLocation getModelResource(RegSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/pomacanthusimperator.geo.json");
    }

    public ResourceLocation getTextureResource(RegSchoolingEntity object) {
        if(object.isBaby()) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/babypomacanthus.png");
        }
        return new ResourceLocation(Animalia.MODID, "textures/entity/pomacanthus_imperator.png");
    }
    ...
    public ResourceLocation getAnimationResource(RegSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/pomacanthusimperator.animation.json");
    }
