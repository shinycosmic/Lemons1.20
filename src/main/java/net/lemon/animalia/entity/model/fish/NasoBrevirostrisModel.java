...
public class NasoBrevirostrisModel extends GeoModel<RegSchoolingEntity> {
    public ResourceLocation getModelResource(RegSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/nasobrevirostris.geo.json");
    }

    public ResourceLocation getTextureResource(RegSchoolingEntity object) {
        if(object.isBaby()) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/babynaso.png");
        }
        return new ResourceLocation(Animalia.MODID, "textures/entity/naso_brevirostris.png");
    }
    ...
    public ResourceLocation getAnimationResource(RegSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/nasobrevirostris.animation.json");
    }
