...
public class ZebrasomaVeliferModel extends GeoModel<GrazeSchoolingEntity> {
    public ResourceLocation getModelResource(GrazeSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/zebrasomavelifer.geo.json");
    }

    public ResourceLocation getTextureResource(GrazeSchoolingEntity object) {
        if(object.isBaby()) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/babyzebrasomavelifer.png");
        }
        if(NightBlend.isFullNight(object)) {
            return new ResourceLocation(Animalia.MODID, "textures/entity/zebrasoma_velifer_night.png");
        }
        return new ResourceLocation(Animalia.MODID, "textures/entity/zebrasoma_velifer.png");
    }
    ...
    public ResourceLocation getAnimationResource(GrazeSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/zebrasomavelifer.animation.json");
    }
