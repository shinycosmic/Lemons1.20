...
public class SiganusVulpinusModel extends GeoModel<RegSchoolingEntity> {
    public ResourceLocation getModelResource(RegSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/siganusvulpinus.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(RegSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/siganusvulpinus.animation.json");
    }
