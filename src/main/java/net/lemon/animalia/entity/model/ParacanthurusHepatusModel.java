...
public class ParacanthurusHepatusModel extends GeoModel<GrazeSchoolingEntity> {
    public ResourceLocation getModelResource(GrazeSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "geo/paracanthurushepatus.geo.json");
    }
    ...
    public ResourceLocation getTextureResource(GrazeSchoolingEntity object) {
        ...
        return new ResourceLocation(Animalia.MODID, "textures/entity/paracanthurus_hepatus.png");
    }
    ...
    public ResourceLocation getAnimationResource(GrazeSchoolingEntity animatable) {
        ...
        return new ResourceLocation(Animalia.MODID, "animations/paracanthurushepatus.animation.json");
    }
