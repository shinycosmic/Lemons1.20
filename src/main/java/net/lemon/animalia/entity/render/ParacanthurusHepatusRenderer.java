...
import net.lemon.animalia.entity.model.fish.ParacanthurusHepatusModel;
...
public class ParacanthurusHepatusRenderer extends GeoEntityRenderer<GrazeSchoolingEntity> {
    private float babyMult = 0.2f;

    public ParacanthurusHepatusRenderer(EntityRendererProvider.Context context) {
        super(context, new ParacanthurusHepatusModel());
    }
