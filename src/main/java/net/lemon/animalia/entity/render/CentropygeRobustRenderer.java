...
import net.lemon.animalia.entity.model.fish.CentropygeRobustModel;
...
public class CentropygeRobustRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.15f;

    public CentropygeRobustRenderer(EntityRendererProvider.Context context) {
        super(context, new CentropygeRobustModel());
    }
