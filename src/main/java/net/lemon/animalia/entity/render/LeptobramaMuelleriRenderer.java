...
import net.lemon.animalia.entity.model.fish.LeptobramaMuelleriModel;
import net.lemon.animalia.entity.model.fish.NematistiusPectoralisModel;
import net.minecraft.client.renderer.MultiBufferSource;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class LeptobramaMuelleriRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.3f;

    public LeptobramaMuelleriRenderer(EntityRendererProvider.Context context) {
        super(context, new LeptobramaMuelleriModel());
    }
