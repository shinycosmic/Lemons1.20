...
import net.lemon.animalia.entity.model.ZebrasomaFlavescensModel;
import net.lemon.animalia.entity.model.ZebrasomaVeliferModel;
...
public class ZebrasomaFlavescensRenderer extends GeoEntityRenderer<GrazeSchoolingEntity> {
