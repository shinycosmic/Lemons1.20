...
public class AcanthurusRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.2f;

    public AcanthurusRenderer(EntityRendererProvider.Context context) {
        super(context, new AcanthurusModel());
    }
