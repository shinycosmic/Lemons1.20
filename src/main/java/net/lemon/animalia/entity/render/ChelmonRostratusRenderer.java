...
import net.lemon.animalia.entity.model.ChelmonRostratusModel;
...
public class ChelmonRostratusRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.2f;

    public ChelmonRostratusRenderer(EntityRendererProvider.Context context) {
        super(context, new ChelmonRostratusModel());
    }
