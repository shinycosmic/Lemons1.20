...
import net.lemon.animalia.entity.model.fish.AcanthurusSlenderModel;
...
public class AcanthurusSlenderRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.2f;

    public AcanthurusSlenderRenderer(EntityRendererProvider.Context context) {
        super(context, new AcanthurusSlenderModel());
    }
