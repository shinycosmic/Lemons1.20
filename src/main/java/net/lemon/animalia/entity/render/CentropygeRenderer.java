...
import net.lemon.animalia.entity.model.fish.CentropygeModel;
...
public class CentropygeRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.15f;

    public CentropygeRenderer(EntityRendererProvider.Context context) {
        super(context, new CentropygeModel());
    }
