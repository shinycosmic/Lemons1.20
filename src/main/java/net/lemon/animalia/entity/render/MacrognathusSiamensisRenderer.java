...
public class MacrognathusSiamensisRenderer extends GeoEntityRenderer<MastacembelusEntity> {
    private float babyMult = 0.3f;

    public MacrognathusSiamensisRenderer(EntityRendererProvider.Context context) {
        super(context, new MacrognathusSiamensisModel());
    }
    ...
    @Override
    protected void applyRotations(MastacembelusEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
