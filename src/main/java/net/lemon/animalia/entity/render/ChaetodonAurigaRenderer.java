...
import net.lemon.animalia.entity.model.fish.ChaetodonAurigaModel;
...
public class ChaetodonAurigaRenderer extends GeoEntityRenderer<RegSchoolingEntity> {
    private float babyMult = 0.2f;

    public ChaetodonAurigaRenderer(EntityRendererProvider.Context context) {
        super(context, new ChaetodonAurigaModel());
    }
