...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<HeterocongerEntity>> HETEROCONGER_HASSI = registerEntityType("heteroconger_hassi", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0xb49689, 0x4d403e, true);
