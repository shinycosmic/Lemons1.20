...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<RegSchoolingEntity>> LEPTOBRAMA_MUELLERI = registerEntityType("leptobrama_muelleri", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.6f, 0.6f, RegSchoolingEntity::setAttributes, 0xf6f6f0, 0x25282e, true);
    ...
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_LEUCOSTERNON = registerEntityType("acanthurus_leucosternon", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0x3379ff, 0x263b63, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_ACHILLES = registerEntityType("acanthurus_achilles", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0x3d3232, 0xff4905, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_JAPONICUS = registerEntityType("acanthurus_japonicus", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0x8a6940, 0xffe500, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_COERULEUS = registerEntityType("acanthurus_coeruleus", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0x056fd4, 0x002d87, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_SOHAL = registerEntityType("acanthurus_sohal", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0xcac2f5, 0x262126, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> ACANTHURUS_LINEATUS = registerEntityType("acanthurus_lineatus", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.5f, 0.3f, RegSchoolingEntity::setAttributes, 0xfed210, 0x90dcff, true);
    ...
    public static final RegistryObject<EntityType<RegSchoolingEntity>> CENTROPYGE_BOYLEI = registerEntityType("centropyge_boylei", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, RegSchoolingEntity::setAttributes, 0xe71b00, 0xfcfcff, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> CENTROPYGE_LORICULA = registerEntityType("centropyge_loricula", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, RegSchoolingEntity::setAttributes, 0xff2700, 0x0c0c0c, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> CENTROPYGE_VENUSTA = registerEntityType("centropyge_venusta", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, RegSchoolingEntity::setAttributes, 0xfffc95, 0x230fdc, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> FORCIPIGER_FLAVISSIMUS = registerEntityType("forcipiger_flavissimus", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, RegSchoolingEntity::setAttributes, 0xffef48, 0x080a09, true);
    public static final RegistryObject<EntityType<RegSchoolingEntity>> FORCIPIGER_LONGIROSTRIS = registerEntityType("forcipiger_longirostris", RegSchoolingEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, RegSchoolingEntity::setAttributes, 0xf8ca16, 0x231129, true);
    ...
    public static final RegistryObject<EntityType<AenigmachannaEntity>> AENIGMACHANNA_GOLLUM = registerEntityType("aenigmachanna_gollum", AenigmachannaEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.9f, AenigmachannaEntity::setAttributes, 0xbe6435, 0x512500, true);
    public static final RegistryObject<EntityType<CavefishEntity>> NEOLISSOCHILUS_PNAR = registerEntityType("neolissochilus_pnar", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.9f, CavefishEntity::setAttributes, 0xcab2db, 0xca93ae, true);
    public static final RegistryObject<EntityType<CavefishEntity>> SATAN_EURYSTOMUS = registerEntityType("satan_eurystomus", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.9f, CavefishEntity::setAttributes, 0xe5c79e, 0xbd8d4b, true);
    ...
    public static final RegistryObject<EntityType<HeterocongerEntity>> HETEROCONGER_HASSI = registerEntityType("heteroconger_hassi", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0xe7dfc0, 0x272935, true);
    public static final RegistryObject<EntityType<HeterocongerEntity>> HETEROCONGER_LUTEOLUS = registerEntityType("heteroconger_luteolus", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0xb08d27, 0x755a0c, true);
    public static final RegistryObject<EntityType<HeterocongerEntity>> HETEROCONGER_POLYZONA = registerEntityType("heteroconger_polyzona", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0xf5efe3, 0x000400, true);
    public static final RegistryObject<EntityType<HeterocongerEntity>> GORGASIA_PRECLARA = registerEntityType("gorgasia_preclara", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0xe38309, 0xf3dcc1, true);
    public static final RegistryObject<EntityType<HeterocongerEntity>> GORGASIA_BARNESI = registerEntityType("gorgasia_barnesi", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0x92756f, 0xe4d5d5, true);
    public static final RegistryObject<EntityType<HeterocongerEntity>> GORGASIA_JAPONICA = registerEntityType("gorgasia_japonica", HeterocongerEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, HeterocongerEntity::setAttributes, 0x321007, 0xfcfff6, true);
