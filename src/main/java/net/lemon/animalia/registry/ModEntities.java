...
//    public static final RegistryObject<EntityType<CavefishEntity>> GITCHAK_NAKANA = registerEntityType("gitchak_nakana", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
    public static final RegistryObject<EntityType<CavefishEntity>> CYPRINODON_DIABOLIS = registerEntityType("cyprinodon_diabolis", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
    public static final RegistryObject<EntityType<CavefishEntity>> AMBLYOPSIS_HOOSIERI = registerEntityType("amblyopsis_hoosieri", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
//    public static final RegistryObject<EntityType<CavefishEntity>> KRYPTOGLANIS_SHAJII = registerEntityType("kryptoglanis_shajii", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
    public static final RegistryObject<EntityType<CavefishEntity>> SINOCYCLOCHEILUS_LONGICORNUS = registerEntityType("sinocyclocheilus_longicornus", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
    public static final RegistryObject<EntityType<CavefishEntity>> SINOCYCLOCHEILUS_ANATIROSTRIS = registerEntityType("sinocyclocheilus_anatirostris", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
    public static final RegistryObject<EntityType<CavefishEntity>> SINOCYCLOCHEILUS_HYALINUS = registerEntityType("sinocyclocheilus_hyalinus", CavefishEntity::new, ModMobCategories.ANIMALIA_FISH, 0.4f, 0.4f, CavefishEntity::setAttributes);
