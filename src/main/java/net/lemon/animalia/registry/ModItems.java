...
//    public static final RegistryObject<Item> LEPTOBRAMA_MUELLERI_BUCKET = registerBucket("leptobrama_muelleri_bucket", ModEntities.LEPTOBRAMA_MUELLERI);
    ...
    //Spawn Eggs
    public static final RegistryObject<Item> DISSOSTICHUS_ELEGINOIDES_SPAWN_EGG = registerSpawnEgg("dissostichus_eleginoides_spawn_egg", ModEntities.DISSOSTICHUS_ELEGINOIDES, 0x4D5267, 0xA5A8B0);
...
//    public static final RegistryObject<Item> BOVICHTUS_VARIEGATUS_SPAWN_EGG = registerSpawnEgg("bovichtus_variegatus_spawn_egg", ModEntities.BOVICHTUS_VARIEGATUS, 0x6e5540, 0xfff0cd);
    ...
    public static final RegistryObject<Item> INDOSTOMUS_PARADOXUS_SPAWN_EGG = registerSpawnEgg("indostomus_paradoxus_spawn_egg", ModEntities.INDOSTOMUS_PARADOXUS, 0x744926, 0xf8efd0);
